    ...
    <header className="relative z-10 w-full">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-8 pb-6">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div className="relative">
            <div className="w-10 h-10 rounded-xl bg-gosports-primary flex items-center justify-center shadow-gosports-md">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                ...
                <path d="M7 11 C7 8 9 6 11 6 C13 6 15 8 15 11" stroke="white" strokeWidth="2" strokeLinecap="round"/>
          ...
          {/* Brand name */}
          <div>
            <span className="font-display text-xl font-700 tracking-tight text-gosports-dark">
          ...
          {/* Badge */}
          <div className="ml-auto hidden sm:flex items-center gap-1.5 bg-gosports-light border border-gosports-primary/20 text-gosports-secondary text-xs font-600 px-3 py-1.5 rounded-full">
        ...
        <div className="text-center space-y-3">
          <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-800 leading-tight text-gosports-dark">
            Como podemos{" "}
